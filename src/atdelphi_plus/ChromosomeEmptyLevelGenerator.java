/*
 * This is like the generator from tracks.levelGeneration.randomLevelGenerator.LevelGenerator
 * However, it has a constant level size set by "LEVEL_WIDTH" and "LEVEL_HEIGHT"
 * This class will have the pseudoname: CHROMOSOME LEVEL GENERATOR
 */
...
public class ChromosomeEmptyLevelGenerator extends AbstractLevelGenerator {
	...
	/**
	 * constant generated level width; number of columns
	 */
	private final int LEVEL_WIDTH = 15;
	
	/**
	 * constant generated level height; number of rows
	 */
	...
	public String generateLevel(GameDescription game, ElapsedCpuTimer elapsedTimer) {
		...
		//Set the level height and width [DIFFERENT FROM RANDOM.LEVELGENERATOR]
		int width = LEVEL_WIDTH;
		int length = LEVEL_HEIGHT;
